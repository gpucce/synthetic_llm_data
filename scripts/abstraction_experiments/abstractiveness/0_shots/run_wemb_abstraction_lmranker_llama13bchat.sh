...
srun python -u -m synthetic_llm_data.src.abstraction_pilot.lmranker_experiment \
    ...
    --output_path "/leonardo_scratch/large/userexternal/gpuccett/data/wemb_abstraction_data/abstraction/0_shots/ranker_experiment/few_shots_ranker_test_13b.csv" \
    --temperature 0.8 \
    --max_batch_size 16 \

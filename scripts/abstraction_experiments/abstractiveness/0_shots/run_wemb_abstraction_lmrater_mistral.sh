...
srun python -u -m synthetic_llm_data.src.abstraction_pilot.lmrater_experiment \
    ...
    --output_path "/leonardo_scratch/large/userexternal/gpuccett/data/wemb_abstraction_data/abstraction/0_shots/rater_experiment/lmrater_experiment_mistral_instruct.csv" \
    --temperature 0.8 \
    --max_batch_size 16 \

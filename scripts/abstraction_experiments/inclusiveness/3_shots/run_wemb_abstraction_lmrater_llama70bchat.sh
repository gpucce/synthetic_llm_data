...
srun python -u -m synthetic_llm_data.src.abstraction_pilot.lmrater_experiment \
    ...
    --output_path "/leonardo_scratch/large/userexternal/gpuccett/data/wemb_abstraction_data/inclusiveness/3_shots/lmrater_experiment/lmrater_experiment_llama70bchat.csv" \
    --temperature 0.8 \
    --max_batch_size 16 \

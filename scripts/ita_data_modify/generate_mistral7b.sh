...
python -m synthetic_llm_data.src.synthetic_detection.detect_gpt.dataset_lm_modification \
    --name-or-path "/leonardo_scratch/large/userexternal/gpuccett/models/hf_mistral/Mistral-7B-v0.1/" \
    ...
    --output-path /leonardo_scratch/large/userexternal/gpuccett/datasets/ita_synthetic_data/mistral7b_vllm \
    --seed 1 \
    --human-key full_text \
    --col-name full_text \
    --length-filter 100 \

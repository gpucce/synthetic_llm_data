...
srun python -u -m synthetic_llm_data.src.synthetic_detection.detect_gpt.dataset_lm_modification \
    --output-path "detectGPT_experiments/outfox/gpt4gen_t5-3bmodif_llama7bdetect_128_max_tok" \
    ...
    --data-path "/leonardo_scratch/large/userexternal/gpuccett/datasets/semeval2024-private/data/en/outfox_GPT4.jsonl" \
    --col-names "document" \
    --batch-size 32 \
    --n-modifications 50 \
    --max-seq-len 128 \

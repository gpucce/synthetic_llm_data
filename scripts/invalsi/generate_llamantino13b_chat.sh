...
python -m synthetic_llm_data.src.invalsi.generation_experiment \
    --name_or_path "/leonardo_scratch/large/userexternal/gpuccett/models/hf_llamantino/LLaMAntino-2-chat-13b-hf-ITA" \
    --output_path /leonardo_scratch/large/userexternal/gpuccett/datasets/ita_llm_data/invalsi_data/invalsi_mate_clean_predicted_llamantino13b_chat.csv \

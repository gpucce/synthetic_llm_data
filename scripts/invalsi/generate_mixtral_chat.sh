...
export PATH="$PATH:/leonardo_scratch/large/userexternal/gpuccett/data/megablocks"

# source /leonardo_scratch/large/userexternal/gpuccett/data/data_venv/bin/activate

# srun 
python -m synthetic_llm_data.src.invalsi.generation_experiment \
    --name_or_path "/leonardo_scratch/large/userexternal/gpuccett/models/hf_mistral/Mixtral-8x7B-Instruct-v0.1" \

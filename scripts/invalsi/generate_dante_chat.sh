...
python -m synthetic_llm_data.src.invalsi.generation_experiment \
    --name_or_path "/leonardo_scratch/large/userexternal/gpuccett/models/hf_dante/Dante7b" \
    --output_path /leonardo_scratch/large/userexternal/gpuccett/data/ita_llm_data/invalsi_data/answers_invalsi_mate_clean_dante.csv \

...
srun python -m synthetic_llm_data.src.invalsi.generation_experiment \
    --name_or_path "/leonardo_scratch/large/userexternal/gpuccett/models/hf_camoscio/camoscio2_13b_v2" \
    --output_path /leonardo_scratch/large/userexternal/gpuccett/data/ita_llm_data/invalsi_data/invalsi_mate_clean_predicted_camoscio13b.csv \
